...
<head>
  ...
  <title>Invitación Fonneta</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding-top: 20px; padding-bottom: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">

    <!-- Header -->
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center;">
      <div style="font-size: 32px; font-weight: 900; color: white; margin-bottom: 10px; letter-spacing: -1px;">🚀 Fonnettapp</div>
      <p style="color: rgba(255,255,255,0.9); font-size: 14px; margin: 0; font-weight: 500;">Tu portal de proveedores</p>
    </div>
    ...
    <div style="padding: 50px 30px;">
      ...
      <div style="text-align: center; margin: 40px 0;">
        <a href="${inviteLink}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 16px 40px; border-radius: 10px; text-decoration: none; font-weight: 900; font-size: 15px; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 8px 20px rgba(102,126,234,0.3);">
          ✓ COMPLETAR REGISTRO
        </a>
      </div>
      ...
      <div style="background: #edf2f7; padding: 25px; border-radius: 10px; margin: 30px 0;">
        <h3 style="color: #1a202c; font-size: 16px; font-weight: 900; margin: 0 0 20px 0;">⚙️ Proceso de Facturación y Pago</h3>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="${inviteLink}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 14px 35px; border-radius: 8px; text-decoration: none; font-weight: 900; font-size: 13px; transition: transform 0.2s;">
          → REGISTRATE AQUÍ
        </a>
      </div>
